...
// existing progress code (keyed by email via base44.auth.me) keeps working.
...
export const AuthProvider = ({ children }) => {
  ...
  // Mirror an email account into localProfile so progressStore / base44.auth.me work unchanged.
