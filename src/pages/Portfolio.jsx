    ...
    <div className="min-h-screen" style={{ background: "#0a0a0a" }}>
      ...
      <div className="relative px-8 lg:px-16 pt-28 pb-16" style={{ borderBottom: "1px solid #1a1a1a" }}>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="font-mono text-xs tracking-widest uppercase mb-2" style={{ color: "#2a2a2a" }}>§ PORTFOLIO</div>
          <h1
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between gap-6">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-mono text-xs flex items-center gap-1" style={{ color: sub.is_public ? "#555" : "#333" }}>
                      ...
                      {sub.description && (
                        <p className="font-display text-sm line-clamp-2" style={{ color: "#555", fontWeight: 400 }}>
                          {sub.description}
                        </p>
                      )}
                    </div>
                  ...
                  {sub.ai_feedback && (
                    ...
                    >
                      ...
                      <span className="font-display text-xs leading-relaxed" style={{ color: "#555", fontWeight: 400 }}>
                        {sub.ai_feedback}
                      </span>
                    </div>
                  )}

                  <div className="mt-3 font-mono text-xs" style={{ color: "#2a2a2a" }}>
